...
import sty from "./PlasmicButton.module.css"; // plasmic-import: oq9TjOPy9RdD/css
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__scuFi, {
          [sty.freeBoxcolor_neutral__scuFIoxYAf]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxroundedFull__scuFIp2EPa]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__scuFi0EXje]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__scuFIrWwi6]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__scuFimRcWe]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__scuFIv1Jb6]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__scuFih9IZ]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__scuFih9IZF802X]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___6QWFf, {
            [sty.freeBoxcolor_neutral___6QWFfoxYAf]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft___6QWFfoxYAfXMhJb]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart___6QWFfpGtRq]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge___6QWFf0EXje]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___6QWFfMRcWe]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___6QWFfv1Jb6]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered___6QWFfH9IZ]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__ncUw)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__oglQy, {
            [sty.freeBoxiconEnd__oglQyASkB5]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__oglQy0EXje]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__oglQyMRcWe]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__oglQyv1Jb6]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__k2VXl)}
                role={"img"}
              />
            ),

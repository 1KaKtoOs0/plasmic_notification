...
import sty from "./PlasmicHomepage.module.css"; // plasmic-import: YPOsLCmZrjaN/css
  ...
  return (
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox___6FFgk)}>
            <div
              className={classNames(
                projectcss.all,
